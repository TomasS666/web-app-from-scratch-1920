...
function Genre(params, name) {
  console.log("test");
  (0, _getData.getData)("discover/movie", params).then(function (data) {
    return data.json();
...
},{"../../helpers/createAndAppend.js":"js/helpers/createAndAppend.js","../../helpers/data/getData":"js/helpers/data/getData.js"}],"js/app.js":[function(require,module,exports) {
"use strict";
...
function init() {
  ...
  _genreList.genreList.forEach(function (obj) {
    (0, _Genre.Genre)("with_genres=".concat(obj.id), obj.name);
